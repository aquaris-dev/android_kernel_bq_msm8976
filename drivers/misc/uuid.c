...
static int get_emmc0_cid(void)
{
	...
	if (emmc_disk) {
		...
		if (card) {
			...
			pr_err("cid_legacy.manfid %u\n", cid_legacy.manfid);
			pr_err("cid_legacy.prod_name[0] %u\n", cid_legacy.prod_name[0]);
			pr_err("cid_legacy.prod_name[1] %u\n", cid_legacy.prod_name[1]);
			pr_err("cid_legacy.prod_name[2] %u\n", cid_legacy.prod_name[2]);
			pr_err("cid_legacy.prod_name[3] %u\n", cid_legacy.prod_name[3]);
			pr_err("cid_legacy.prod_name[4] %u\n", cid_legacy.prod_name[4]);
			pr_err("cid_legacy.prod_name[5] %u\n", cid_legacy.prod_name[5]);
			pr_err("cid_legacy.prod_name[6] %u\n", cid_legacy.prod_name[6]);
			pr_err("cid_legacy.prod_name[7] %u\n", cid_legacy.prod_name[7]);
			pr_err("cid_legacy.serial %u\n", cid_legacy.serial);
			pr_err("cid_legacy.oemid %u\n", cid_legacy.oemid);
			pr_err("cid_legacy.year %u\n", cid_legacy.year);
			pr_err("cid_legacy.hwrev %u\n", cid_legacy.hwrev);
			pr_err("cid_legacy.fwrev %u\n", cid_legacy.fwrev);
			pr_err("cid_legacy.month %u\n", cid_legacy.month);
...
static void set_cmdline_serialno(void)
{
	...
	if (value_length == 16) {
		// replace default serialno "1234567890ABCDEF" with generated one
